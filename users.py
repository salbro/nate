...
class User():
    ...
    def is_authenticated(self):
        ...
        print("authenticated in user: " + str( self.get_password(credentials, self.username) == self.password))
        return self.get_password(credentials, self.username) == self.password
    ...
    def is_active(self):
        ...
        with open(CREDS, "r") as fp:
            d = json.load(fp)
            print(d)
            return self.username in list(d.keys())
    ...
    def is_anonymous(self):
        ...
        '''
        with open(CREDS, "r") as fp:
            return self.username not in json.load(fp).keys()
    ...
    def get_id(self):
        ...
        '''
        with open(CREDS, "r") as fp:
            return json.load(fp)[self.username]['id']
